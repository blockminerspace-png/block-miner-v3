...
const MILESTONES = [
  {
    ...
    items: [
      ...
      { icon: ShieldCheck,  label: 'Autenticação 2FA',                  status: S.LAUNCHED },
  ...
  },
  {
    ...
    items: [
      ...
      { icon: Zap,          label: 'PTC (Paid-to-Click)',               status: S.LAUNCHED },
      { icon: Gift,         label: 'Offerwall (Offerwall.me)',          status: S.LAUNCHED },
