...
checkinRouter.post("/wallet", requireAuth, confirmLimiter, checkinController.checkinWallet);
checkinRouter.post("/balance", requireAuth, confirmLimiter, checkinController.checkinBalance);
